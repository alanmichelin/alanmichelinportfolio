  ...
  const Projects = () =>{
    ...
    <Grid container spacing={3}>
        <Grid item xs={12} sm={12}>
            ...
            <Project name={`PongJS`} description={`PongJS is just the PONG videogame made with pure JavaScript.
            ...
            <Project name={`VideoDownloader`} description={`As title says, this is an app that can download videos from Facebook, Instagram and Youtube. 
                I've learned a lot while doing this app, since everything must be asynchronic. The way it works with Facebook and Instagram, is by intercepting the media response of a video, getting the mp4 and creating a file.
            ...
            <Project name={`FrontEnd e-commerce`} description={`This is the last project i did. With this one i've learned a lot about React foundaments(split code in components, useState, useEffect, optimizing and making reusable code) along with some JavaScript logic. 
